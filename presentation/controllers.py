...
def search():
    ...
    weights = {
        'color':         request.form.get('weight_color',         default=0.10, type=float),
        'color_moments': request.form.get('weight_color_moments', default=0.00, type=float),
        'texture':       request.form.get('weight_texture',       default=0.20, type=float),
        'glcm':          request.form.get('weight_glcm',          default=0.70, type=float),
