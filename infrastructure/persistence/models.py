...
class FeatureTable(db.Model):
    ...
    color = db.Column(Vector(1024))
    color_moments = db.Column(Vector(9))
    texture = db.Column(Vector(10))
    glcm = db.Column(Vector(4))
    shape = db.Column(Vector(7))
    gabor = db.Column(Vector(16))
    hog = db.Column(Vector(8100))
    convex_hull = db.Column(Vector(3))
    aspect_ratio = db.Column(Vector(1))
    zernike = db.Column(Vector(25))
